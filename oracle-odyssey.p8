...
function update_player()
    ...
    if player.dy < 0 then
        player.sprite = player.jump_up_sprite
    elseif player.dy > 0 then
        player.sprite = player.jump_down_sprite
    end
...
function draw_player()
    ...
    if player.state == "jumping" then
        if player.dy < 0 then
            frames = player.jump_up_frames
        else
            frames = player.jump_down_frames
        end
    end
...
function draw_obstacles()
    for obstacle in all(obstacles) do
        ...
        local height_in_sprites = ceil(obstacle.height / 8)
...
function old_draw_power_up_timer()
    if player.double_jump_enabled then
        ...
        print(timer_text, screen_size - (#timer_text * 4) - 1, 2, 12)
    end
end
...
function draw_power_up_timer()
    if player.double_jump_enabled then
        ...
        local bg_color = flr(time() * 10) % 2 == 0 and 5 or 6
        rectfill(x - 2, y - 2, x + text_width + 1, y + 6, bg_color)

        -- draw the timer text with a shadow effect
        print(timer_text, x + 1, y + 1, 0)  -- shadow
        print(timer_text, x, y, color)      -- main text
    end
end
...
function draw_splash() 
    -- load intro sprites temporarily
    reload(0x0000, 0x0000, 0x2000, "intro-screen.p8")
    -- draw the full 128x128 spritesheet as intro image
    spr(0, 0, 0, 16, 16)
    -- restore game sprites
...

...

...

...

...

...
__map__

...

__sfx__
